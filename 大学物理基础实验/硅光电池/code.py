    ...
    with tf.Session() as sess:
        ...
        for i in range(10000):
            ...
            if i % 50 == 0:
                ...
                # 绘制模型预测值。
                lines = ax.plot(x_data*10, prediction_value, color, lw=3)
                plt.pause(1)
                # 打印损失
...
y=[2.440,2.430,2.423,2.418,2.414,2.408,2.404]
plt.ylim(2.39,2.45)
curve(x,y,"d(cm)","U(V)","反向偏压下硅光电池的电流与光照测量")
