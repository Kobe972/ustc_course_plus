...
class NetworkInterface {
  private:
    ...
    std::map<uint32_t, EthernetAddress> _arp_table{};
    std::map<uint32_t, size_t> _ttl{};
    size_t _timer = 0;
    std::queue<OutstandingFrame> _outstanding_frames{};
    std::map<uint32_t, size_t> _ip_time_table{}; 
